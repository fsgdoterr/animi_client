        ...
        <article className="group block min-w-0">
            <div className="relative">
                <Link
                    ...
                    className="relative block aspect-[3/4] overflow-hidden rounded-xl border border-white/[0.055] bg-[#13191e] shadow-[0_12px_32px_rgba(0,0,0,.18)]"
                >
                    {poster ? (
                        <Image
                            src={poster}
                ...
                <BookmarkButton animeId={anime.id} className="absolute left-2 top-2 z-10" />
            </div>
